...
@section("mete_keyword","$category->mete_keyword")
                            ...
                            <div class="box">
                                ...
                                @forelse ($post as $postitem)
                                    <div class="card card-shadow">
                                        <div class="card-body">
                                            <a href="{{ url('postnewitem/'.$category->slug.'/'.$postitem->slug)  }}">
                                                <h2>{{ $postitem->name }}</h2>
                                            </a>
                                            <div class="date_post mr-5 pr-5 d-flex justify-content-between">
                                                <span>Posted On: {{ $postitem->created_at->format('d-m-Y') }}</span>
                                                <span>Posted By: {{ $postitem->user->name }}</span>
                                            </div>
                                        </div>
                                    </div>
                                @empty
                                    <p class="text-center text-danger">Post Not Available in this Category!</p>
                                @endforelse
